...
class User(SQLModel, table=True):
    ...
    google_id: str | None = Field(default=None, sa_column=Column(String(255), nullable=True, unique=True, index=True))
    stripe_customer_id: str | None = Field(default=None, sa_column=Column(String(255), nullable=True, unique=True))
    subscription_status: str = Field(default="none", sa_column=Column(String(20), nullable=False))
    trial_ends_at: datetime | None = Field(default=None, sa_column=Column(DateTime(timezone=True), nullable=True))
    telegram_chat_id: str | None = Field(default=None, sa_column=Column(String(255), nullable=True))
    is_admin: bool = Field(default=False)
    gdpr_consent_at: datetime | None = Field(default=None, sa_column=Column(DateTime(timezone=True), nullable=True))
